        ...
        <div className="flex flex-col gap-2">
            <Card >
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Create your account to contine
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <FormProvider {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <div className=" p-4 w-full flex flex-col items-center justify-center">
                                ...
                                <FieldGroup className="flex flex-col gap-4 items-center justify-center">
                                    ...
                                    <Field>
                                        <FieldLabel htmlFor="confirmPassword" className="text-2xl font-semibold" >Confirm Password</FieldLabel>
                                        <Input id="confirmPassword" type="password" placeholder="******" {...form.register("confirmPassword")}></Input>
